...
data_patient_linear_check <- data_patient_complete |>
  ...
  mutate(
    probabilites = predict(model_full$fit, data_patient_complete, type = "response"),
    log_odds = log(probabilites / (1 - probabilites))
  ) |>
  select_if(is.numeric) |>
  gather(key = "predictors", value = "predictor_value", -log_odds, -probabilites)
