...
# model_full_HPM_1_A_ND <- model_basic_flow_1_A_ND |>
#   update_variables(outcomes = "flag_ADR_TP_ID", predictors = all_of(multi_predict_HPM_1_A_ND)) |>
#   fit(data = data_patient_screen_full_ND)

# model_beta_estimates_1_A_ND <- model_full_HPM_1_A_ND |>
#   tidy() |>
#   select(term, estimate, p.value)

# model_odds_ratios_1_A_ND <- model_full_HPM_1_A_ND |>
...
# data_refit_1_A_ND <- model_full_HPM_1_A_ND |>
#   extract_mold() |>
#   _$predictors |>
#   mutate(across(where(is.numeric), ~ . / 10)) |>
#   rename_with(~ paste0(., "_per_10"), .cols = where(is.numeric)) |>
#   bind_cols(model_full_HPM_1_A_ND |> extract_mold() |> _$outcomes)
...
# model_refit_odds_ratios_1_A_ND |>
#   flextable::flextable() |>
#   flextable::save_as_docx(path = "data/model-performance/model-refit-odds-ratios-1-A-ND.docx")
```