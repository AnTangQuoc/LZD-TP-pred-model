...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, titlerule=0mm, toprule=.15mm, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, toptitle=1mm, opacityback=0, colback=white, breakable, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, coltitle=black, titlerule=0mm, toprule=.15mm, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, opacitybacktitle=0.6, toptitle=1mm, opacityback=0, colback=white, breakable, arc=.35mm, bottomtitle=1mm, bottomrule=.15mm, rightrule=.15mm]
