...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, breakable, opacityback=0, colframe=quarto-callout-warning-color-frame, left=2mm, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, colback=white, coltitle=black, arc=.35mm, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, breakable, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, bottomrule=.15mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, colback=white, coltitle=black, arc=.35mm, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6]
