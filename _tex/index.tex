...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, breakable, bottomtitle=1mm, coltitle=black, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, bottomrule=.15mm, colback=white, toptitle=1mm, titlerule=0mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, arc=.35mm, opacitybacktitle=0.6]
