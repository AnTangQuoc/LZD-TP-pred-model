...
Note: 2 periods, convenience sampling (1st), extract from the electronic
medical record (except BM1 from physical MR). Infomation was filled out
in a paper form and stored in Excel.
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, leftrule=.75mm, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, rightrule=.15mm, left=2mm, toptitle=1mm, opacityback=0, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, coltitle=black, leftrule=.75mm, arc=.35mm, breakable, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, left=2mm, toptitle=1mm, opacityback=0, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white]
...
Infection diagnosis was recoded into binary variable\ldots.

look up by ID number. Điền thông tin về bệnh mắc kèm, bệnh nhiễm khuẩn
và thuốc dùng kèm từ

1 BN có 2 đợt điều trị -\textgreater{} 2 entry have identical ID number
-\textgreater{} manually sort and exclude the 2nd course Cepha, peni và
carbapenem.
